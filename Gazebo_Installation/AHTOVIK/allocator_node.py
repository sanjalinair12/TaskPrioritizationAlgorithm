...
class AllocatorNode(Node):
    def __init__(self):
        ...
        # Example: Load your data (replace paths with real ones)
        self.df_cc = pd.read_csv('/path/to/criteria_comparison.csv', index_col=0)
        self.df_tasks = pd.read_csv('/path/to/tasks.csv', index_col=0)
        self.df_robots = pd.read_csv('/path/to/robots.csv', index_col=0)
